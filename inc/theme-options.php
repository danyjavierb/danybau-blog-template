...
function grisaille_options_do_page() {
	...
	<div class="wrap">
		...
		<p><?php _e( 'These options will let you setup the three social icons at the top of the theme. You can enter the URLs of your profiles to have the icons show up.', 'grisaille' ); ?></p>
